          ...
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-12 lg:col-span-7 space-y-12">
              <Reveal as="article" className="border-t border-black pt-6">
                ...
                <h2 className="display-heading text-3xl font-bold text-black mt-2">INK CHARITY</h2>
                <p className="text-base text-gray-700 leading-relaxed font-normal mt-4">
                  We process personal data strictly to verify donations, coordinate clothing/food item pickups, issue receipts, and manage direct logistics.
                </p>
              </Reveal>
              ...
              <Reveal as="article" className="border-t border-black pt-6" delay={60}>
                ...
                <p className="text-base text-gray-700 leading-relaxed font-normal mt-4">
                  We log donor names, phone numbers, M-Pesa transaction reference numbers, donation amounts, and item pickup or delivery addresses.
                </p>
              </Reveal>

              <Reveal as="article" className="border-t border-black pt-6" delay={120}>
                <p className="eyebrow text-black">03 / Purpose &amp; Processing</p>
                <h2 className="display-heading text-3xl font-bold text-black mt-2">Direct Field Logistics &amp; Accounting</h2>
                <p className="text-base text-gray-700 leading-relaxed font-normal mt-4">
                  Data is processed to dispatch collection vehicles, issue confirmation receipts, prevent fraud, and audit field operational deliveries to homes and schools.
                </p>
              </Reveal>
            </div>
            ...
            <Reveal as="div" className="col-span-12 lg:col-span-5 border-t lg:border-t-0 lg:border-l border-black pt-8 lg:pt-0 lg:pl-10 space-y-6" delay={100}>
              ...
              <ul className="space-y-4 text-sm font-semibold text-black">
                <li className="border-b border-black pb-3">Inspect personal records held by INK CHARITY.</li>
