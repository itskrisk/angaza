...
const breakdown = [
  { label: 'Direct Food Transport & Fuel', value: '62%' },
  { label: 'Community Kitchen Operating Grants', value: '24%' },
  { label: 'Packaging & Storage Supplies', value: '9%' },
  { label: 'Ledger Audit & Administration', value: '5%' },
];
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-28">
          <div className="grid grid-cols-12 gap-8 items-end">
            <Reveal as="div" className="col-span-12 lg:col-span-7">
              <p className="eyebrow text-gray-500 mb-4">Financial Audit & Transparency</p>
            ...
            <Reveal as="div" className="col-span-12 lg:col-span-5 border-t lg:border-t-0 lg:border-l border-black pt-8 lg:pt-0 lg:pl-10 space-y-4" delay={120}>
              <p className="text-xl text-black font-normal leading-relaxed">
                The honest version is not a marketing PDF. It is an itemized breakdown of collections, transport costs, and drop-off ledgers.
              </p>
            </Reveal>
          </div>
        </div>
          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <Reveal as="div" className="col-span-12 lg:col-span-5 space-y-6">
              ...
              <p className="text-base text-gray-700 leading-relaxed font-normal">
                These percentages represent active operational expenditure for the 2026 reporting period. Full bank ledgers and receipts are open to donor inspection.
              </p>
            </Reveal>
            ...
            <Reveal as="div" className="col-span-12 lg:col-span-7 border-t lg:border-t-0 lg:border-l border-black pt-8 lg:pt-0 lg:pl-10 space-y-6" delay={100}>
              ...
              <p className="text-xs font-semibold uppercase tracking-wider text-gray-500">
                Reporting Period: Jan 2026 to Sept 2026 • Auditor Verified
              </p>
            </Reveal>
